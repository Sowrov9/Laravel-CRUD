        ...
        <div class="card radius-15">
            <div class="card-body">
                <div class="d-flex mb-2">
                    <div>
                        <p class="mb-0 font-weight-bold">Rooms</p>
                        <h2 class="mb-0">26</h2>
                    </div>
    ...
    <div class="col-12 col-lg-4">
        <div class="card radius-15">
            <div class="card-body">
                <div class="d-flex mb-2">
                    <div>
                        <p class="mb-0 font-weight-bold">Booking Rooms</p>
                        <h2 class="mb-0">12</h2>
                    </div>
                    <div class="ml-auto align-self-end">
    ...
    <div class="col-12 col-lg-4">
        <div class="card radius-15">
            <div class="card-body">
                <div class="d-flex mb-2">
                    <div>
                        <p class="mb-0 font-weight-bold">Available Rooms</p>
                        <h2 class="mb-0">14</h2>
                    </div>
                    <div class="ml-auto align-self-end">
        ...
        <div class="card radius-15">
            <div class="card-header border-bottom-0">
                <div class="d-lg-flex align-items-center">
                    <div>
                        <h5 class="mb-lg-0">Booked vs available Rooms </h5>
                    </div>
